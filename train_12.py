...
from data.S3DIS_dataset_v1 import dataloader, ms_map
...
# from aaai_ws.S3DIS_dataset_v11 import dataloader, ms_map
# from aaai_ws.base_model import get_param_groups
# from aaai_ws.model_s3dis_v12 import RandLANet_S3DIS, RandLA_S3DIS_WithLoss
...
class UpdateLossEpoch(Callback):
    def __init__(self, logger):
        ...
        self.training_ep.update({i: 0 for i in range(0, 30)})
        self.logger = logger
...
def train(cfg, args):
    ...
    update_loss_epoch_cb = UpdateLossEpoch(logger)
...
if __name__ == "__main__":
    ...
    output_dir = f"./runs/pretrain_s3dis_v12"
    ...
    shutil.copy('train_12.py', str(args.outputs_dir))
